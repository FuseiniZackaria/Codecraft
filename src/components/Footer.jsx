...
export default function Footer() {
  return (
    <footer className="bg-[#07122a] border-t border-white/5 px-6 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8 pb-8 border-b border-white/10">
          ...
          <div className="flex items-center gap-4">
            {/* Facebook */}
            <a href="https://web.facebook.com/profile.php?id=61572096340850" target="_blank" rel="noreferrer"
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/justcodecraft/" target="_blank" rel="noreferrer"
              className="w-10 h-10 bg-white/5 hover:bg-[#f26522] border border-white/10 hover:border-[#f26522] rounded-full flex items-center justify-center text-white/60 hover:text-white transition-all duration-300"
            ...
            {/* Twitter / X */}
            <a href="https://twitter.com/CodeCraft" target="_blank" rel="noreferrer"
              className="w-10 h-10 bg-white/5 hover:bg-[#f26522] border border-white/10 hover:border-[#f26522] rounded-full flex items-center justify-center text-white/60 hover:text-white transition-all duration-300"
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com/company/CodeCraft" target="_blank" rel="noreferrer"
              className="w-10 h-10 bg-white/5 hover:bg-[#f26522] border border-white/10 hover:border-[#f26522] rounded-full flex items-center justify-center text-white/60 hover:text-white transition-all duration-300"
              aria-label="LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm text-center sm:text-left">
            © 2026 <strong className="text-white font-bold">CODECRAFT &lt;/&gt;</strong> · All rights reserved · Accra, Ghana
          </p>
          <div className="flex flex-wrap gap-5 justify-center">
            {[["🛡", "Secure & Reliable"], ["⚡", "Fast Delivery"], ["📈", "Results Driven"]].map(([icon, label]) => (
              <div key={label} className="flex items-center gap-2 text-white/60 text-xs font-semibold">
